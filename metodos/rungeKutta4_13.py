...
class Runge_Kutta4_13:
    ...
    def solve(self):
        ...
        k2 = self.h * ( ( ( self.y0 + (k1/2) )  + ( self.t0 + (self.h/2)) )**2  / ( 1 - (self.y0 + (k1/2 ) )   ) ) 
        k3 = self.h * (      ( (self.y0 + (k2/2))  + (self.t0 + (self.h/2) ) )**2     /      ( 1 - ( self.y0 + (k2/2) ) )       )
        k4 = self.h * ( ((self.y0) + (k3) + (self.t0 + (self.h)) )**2 / (1 - (self.y0 + (k3))) )
        ...
        k22 = self.h * ( ( ( y1 + (k12/2) )  + ( t1 + (self.h/2)) )**2  / ( 1 - (y1 + (k12/2 ) )   ) ) 
        k32 = self.h * ( ( (y1 + (k22/2))  + (t1 + (self.h/2) ) )**2     /      ( 1 - (y1 + (k22/2) ) )       )
        k42 = self.h * ( ((y1) + (k32) + (t1 + (self.h)) )**2 / (1 - (y1 + (k32))) )
