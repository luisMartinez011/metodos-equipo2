...
class Runge_Kutta4_38:
    ...
    @staticmethod
    def methodName():
        return "Runge Kutta 4: 3/8 Simpson (K2) del problema Libro: INCORRECTO"
    ...
    def solve(self):
        ...
        k2 = self.h * ( ((-self.y0) + (k1/3))  / (  (((self.y0)+(k1/3))**2) + ((self.t0) + (self.h/3)))  )
        k3 = self.h * (( (-self.y0) + (k1/3) + (k2))/  ( (((self.y0)+(k1/3)+(k2/3))**2) + (self.t0 + ((2/3)*self.h) )  )  )
        k4 = self.h * (( (-self.y0) + (k1) - (k2) + (k3) ) / ( (((self.y0) + (k1) - (k2) + (k3) )**2) + (self.t0 + self.h ) ) )
        ...
        k22 = self.h * ( ((-y1) + (k12/3))  / (  (((y1)+(k12/3))**2) + ((t1) + (self.h/3)))  )
        k32 = self.h * (( (-y1) + (k12/3) + (k22))/  ( (((y1)+(k12/3)+(k22/3))**2) + (t1 + ((2/3)*self.h) )  )  )
        k42 = self.h * (( (-y1) + (k12) - (k22) + (k32) ) / ( (((y1 + (k12) - (k22) + (k32) )**2) + (t1 + self.h ) ) ))
